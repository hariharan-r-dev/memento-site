...
export const collections: Collection[] = [
  {
    ...
    name: "Devotional",
    description:
      "Sacred symbols, familiar stories, and things that feel close to home.",
  ...
  },
  {
    ...
    name: "Food",
    description:
      "Sweet treats, comforting sips, and daily indulgences that bring joy to your desk.",
    shortDesc: "Sweet treats, comforting sips, and daily indulgences.",
    charms: charms.filter((c) => c.category === "Food"),
    comingSoon: false,
  },
  {
    id: "dc",
  ...
  },
  {
    ...
    charms: charms.filter((c) => c.category === "Marvel"),
    comingSoon: false,
  },
]
